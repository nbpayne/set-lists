(function () {
  ...
  describe('SongListService', function () {
    ...
    it('should save a song list to local storage', function () {
      var songList = {};
      /* jshint -W117, -W030 */
      songList.data = getJSONFixture('song-list/song-list.mock.json');
    ...
    it('should get an empty song list from local storage if the server is not available and there is no song list ' +
      'in local storage', function () {
